...
### 3.4 Orange Tech 4 (Satellite Landing)

Rating: B

This is one of the most debated techs, if not the most. Some players favor satellite starts, revering landing on Phobos and Deimos. Others dismiss it, considering it only when tech is full.

Two main questions to discuss:

1. Which moons are strong?
2. Is a satellite start worthwhile?
...
1. 10 points, 4 energy: The strongest energy-reversing satellite, increasingly valuable late-game, the best fuel for scanning engines.
...
Satellite value is decent, and mid-to-late game supplementing with a satellite tech is reasonable, as main planets might be fully landed, leaving nowhere else to go.

Now, is a satellite start advisable? This boils down to whether it's worth taking satellite tech for a Phobos start, as other planets don't offer such dramatic early returns and have less endgame variance.
...
3. Unbalanced development, reliant on subsequent card draws. SETI isn't a traditional engine-building game; its cards provide immediate and mission effects, not continuous income. Even without considering high landing costs, post-landing issues arise:
   ...
   2. No subsequent tech: Satellite tech is mostly unused in round 2. Ideally, landing a 2-trace spot is nice, but perfect map scenarios are rare, often still needing 3 energy to land.
   3. No traces, no trace competition potential. Round 2 aliens introduce new mechanics while you're still playing human cards. If aiming to land another satellite for traces, resources might be insufficient for landing, and even if successful, cards can't be played due to resource constraints, still lacking data.
...
5. Main planets might not be worse than moons. Main planets provide data, and even if a satellite is accessible, you might prioritize the first main planet, making satellite tech a loss.
...
### 4.1 Purple Tech 1 (Earth Surrounding Scan)

Rating: A

Some players love starting with Purple 1, as its 2 data allows for stable 4 data income tuck in round 1. Its effect isn't useless, providing flexibility when scanning sectors.

Overall, it's a transitional tech, not highly profitable, occupying an early tech slot. Avoid it if possible.
