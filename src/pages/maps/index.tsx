...
//     const id = router.query.map ? router.query.map : maps?.[0].id || 0;
...
//   return (
//     <Layout>
//       <Seo templateTitle='Seti Maps & Alternatives' />

//       <div className='flex flex-col gap-4 px-2 py-2 md:px-4'>
//         <Alert className='bg-primary-500/40'>
...
//                 className='h-12 hover:text-primary-600'
//                 selectClassName='text-primary-600 ring-primary-600/90 ring-2'
...
//             height={1000}
//           />
//           <h1 className='scroll-m-20 pt-4 text-2xl font-extrabold tracking-tight text-primary-700 lg:text-4xl'>
//             {t(selectedMap.name)}
//           </h1>
...
//           {selectedMap.id === 'm14' && (
//             <div
//               className='flex items-center text-primary-800 no-underline hover:underline'
...
// export const getStaticProps: GetStaticProps<Props> = async ({ locale }) => ({
//   props: {
//     ...(await serverSideTranslations(locale ?? 'zh-CN', ['common', 'seti', 'flavorText'])),
//   },
// });
