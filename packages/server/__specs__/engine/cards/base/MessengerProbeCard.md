# cards/base/MessengerProbeCard.ts 规则说明

## 1、文件主要功能
- 源文件：`packages/server/src/engine/cards/base/MessengerProbeCard.ts`
- 对应单测：`packages/server/__tests__/engine/cards/base/MessengerProbeCard.test.ts`
