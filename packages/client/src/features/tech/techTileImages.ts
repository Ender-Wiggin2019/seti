...
const PROBE_TILE_BY_LEVEL: Record<number, string> = {
  0: '/assets/seti/tech/tiles/techFly2.webp',
  1: '/assets/seti/tech/tiles/techFly1_SE.0.0.3.webp',
  2: '/assets/seti/tech/tiles/techFly3_SE0.2.jpg',
  3: '/assets/seti/tech/tiles/techFly4.webp',
};

const SCAN_TILE_BY_LEVEL: Record<number, string> = {
  0: '/assets/seti/tech/tiles/techLook1.webp',
  1: '/assets/seti/tech/tiles/techLook4_SE0.4.jpg',
  2: '/assets/seti/tech/tiles/techLook2.webp',
  3: '/assets/seti/tech/tiles/techLook3_SE0.1.webp',
};

export function getTechTileImageByCategory(tech: ETech, level: number): string {
  if (tech === ETech.PROBE) {
    return (
      PROBE_TILE_BY_LEVEL[level] ??
      `/assets/seti/tech/tiles/techFly${level + 1}.webp`
    );
  }

  if (tech === ETech.SCAN) {
    return (
      SCAN_TILE_BY_LEVEL[level] ??
      `/assets/seti/tech/tiles/techLook${level + 1}.webp`
    );
  }
