...
describe('GameLayout', () => {
  ...
  describe('Board Tabs', () => {
    ...
    it('Board tab shows solar system and sectors together', async () => {
      ...
      expect(screen.getByText(/Solar system.*sectors/)).toBeInTheDocument();
    });
    ...
    it('switches tab content on click', async () => {
      ...
      expect(screen.getByText(/12 tech stacks grid/)).toBeInTheDocument();
    });
  });
  ...
  describe('Bottom Bar', () => {
    ...
    it('shows pending input indicator', async () => {
      ...
      expect(screen.getByText(/Input required: sector/)).toBeInTheDocument();
    });
