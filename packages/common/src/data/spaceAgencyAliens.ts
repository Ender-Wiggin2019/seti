...
import { EAlienIcon, EResource, ESector } from '@seti/common/types/element';

const _spaceAgencyAliens: IBaseCard[] = [
  {
    id: 'ET.1',
    name: 'sa.glyphids-title',
    position: { src: '/seti-assets/aliens/glyphids.webp', row: 0, col: 0 },
  ...
  },
  {
    id: 'ET.2',
    name: 'sa.glyphids-title',
    position: { src: '/seti-assets/aliens/glyphids.webp', row: 0, col: 1 },
    freeAction: [{ type: EAlienIcon.GLYPH_ORANGE, value: 1 } as any],
    sector: ESector.BLUE,
    price: 1,
  ...
  },
  {
    id: 'ET.3',
    name: 'sa.glyphids-title',
    position: { src: '/seti-assets/aliens/glyphids.webp', row: 0, col: 2 },
  ...
  },
  {
    id: 'ET.4',
    name: 'sa.glyphids-title',
    position: { src: '/seti-assets/aliens/glyphids.webp', row: 0, col: 3 },
  ...
  },
  {
    id: 'ET.5',
    name: 'sa.glyphids-title',
    position: { src: '/seti-assets/aliens/glyphids.webp', row: 0, col: 4 },
    freeAction: [{ type: EAlienIcon.GLYPH_GRAY, value: 1 } as any],
    sector: ESector.YELLOW,
    price: 1,
    income: EResource.ENERGY,
  ...
  },
  {
    id: 'ET.6',
    name: 'sa.glyphids-title',
    position: { src: '/seti-assets/aliens/glyphids.webp', row: 1, col: 0 },
  ...
  },
  {
    id: 'ET.7',
    name: 'sa.glyphids-title',
    position: { src: '/seti-assets/aliens/glyphids.webp', row: 1, col: 1 },
  ...
  },
  {
    id: 'ET.8',
    name: 'sa.glyphids-title',
    position: { src: '/seti-assets/aliens/glyphids.webp', row: 1, col: 2 },
  ...
  },
  {
    id: 'ET.9',
    name: 'sa.glyphids-title',
    position: { src: '/seti-assets/aliens/glyphids.webp', row: 1, col: 3 },
    freeAction: [{ type: EAlienIcon.GLYPH_GREEN, value: 1 } as any],
    sector: ESector.YELLOW,
    price: 1,
    income: EResource.CREDIT,
  ...
  },
  {
    id: 'ET.10',
    name: 'sa.glyphids-title',
    position: { src: '/seti-assets/aliens/glyphids.webp', row: 1, col: 4 },
  ...
  },
  {
    ...
    position: { src: '/seti-assets/aliens/amoeba.webp', row: 0, col: 0 },
    freeAction: [
  ...
  },
  {
    ...
    position: { src: '/seti-assets/aliens/amoeba.webp', row: 0, col: 1 },
    freeAction: [
      { type: EResource.SCORE, value: 1 },
      { type: EResource.DATA, value: 1 },
    ],
  ...
  },
  {
    ...
    position: { src: '/seti-assets/aliens/amoeba.webp', row: 0, col: 2 },
    freeAction: [
      { type: EResource.SCORE, value: 1 },
      { type: EResource.DATA, value: 1 },
    ],
  ...
  },
  {
    ...
    position: { src: '/seti-assets/aliens/amoeba.webp', row: 0, col: 3 },
    freeAction: [
      { type: EResource.SCORE, value: 1 },
  ...
  },
  {
    ...
    position: { src: '/seti-assets/aliens/amoeba.webp', row: 0, col: 4 },
  ...
  },
  {
    ...
    position: { src: '/seti-assets/aliens/amoeba.webp', row: 1, col: 0 },
    freeAction: [{ type: EResource.PUBLICITY, value: 2 }],
    sector: ESector.BLUE,
    price: 2,
    income: EResource.CARD,
  ...
  },
  {
    ...
    position: { src: '/seti-assets/aliens/amoeba.webp', row: 1, col: 1 },
    freeAction: [
      { type: EResource.SCORE, value: 1 },
      { type: EResource.MOVE, value: 1 },
    ],
  ...
  },
  {
    ...
    position: { src: '/seti-assets/aliens/amoeba.webp', row: 1, col: 2 },
    freeAction: [
      { type: EResource.SCORE, value: 1 },
      { type: EResource.DATA, value: 1 },
    ],
  ...
  },
  {
    ...
    position: { src: '/seti-assets/aliens/amoeba.webp', row: 1, col: 3 },
    freeAction: [{ type: EResource.PUBLICITY, value: 2 }],
    sector: ESector.BLACK,
    price: 0,
    income: EResource.ENERGY,
  ...
  },
  {
    ...
    position: { src: '/seti-assets/aliens/amoeba.webp', row: 1, col: 4 },
    freeAction: [
      { type: EResource.SCORE, value: 1 },
      { type: EResource.MOVE, value: 1 },
    ],
...
export const spaceAgencyAliens: IBaseCard[] = _spaceAgencyAliens.map((card) => {
  ...
  return {
    ...
    special: {
      ...
      titleHeight: 86,
      enableEffectRender: true,
      watermark: card.alien ? false : true,
      faq: FAQ[id],
    },
