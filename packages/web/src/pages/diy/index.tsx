...
import { CardRender, EffectFactory } from '@seti/cards';
import { DEFAULT_BASE_CARD } from '@seti/common/data/defaultCards';
import { IBaseCard } from '@seti/common/types/BaseCard';
import { Effect } from '@seti/common/types/effect';
import { EResource, ESector, TSize } from '@seti/common/types/element';
import {
  effects2FreeAction,
  freeAction2Effect,
  freeActions2Effects,
